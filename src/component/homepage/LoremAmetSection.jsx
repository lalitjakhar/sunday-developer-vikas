...
const LorenAmetSection = () => {
  return (
    <>
      <div>
        <Box>
          <Container maxWidth="lg">
            <Box className="LoremAmetSection"
              sx={{
                display: "flex",
            ...
            >
              <Box width={"50%"}>
               <Box>
               <img
                  src="src/assets/loremametsection/loremametsection.png"
                  alt=""
                  width={"100%"}
                />
               </Box>
              </Box>
              <Box width={"50%"}sx={{display:"grid",alignItems:"center",justifyContent:"end"}}>
...
export default LorenAmetSection;
